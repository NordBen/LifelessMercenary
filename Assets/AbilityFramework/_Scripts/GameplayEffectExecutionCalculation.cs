...
public abstract class GameplayEffectExecutionCalculation : ScriptableObject
{
    ...
    protected abstract void CalculateExecution(GameplayEffect effect, GameplayAttributeComponent source, GameplayAttributeComponent target, Dictionary<GameplayAttribute, float> capturedAttributes, ref Dictionary<GameplayAttribute, float> outModifications);

    private Dictionary<GameplayAttribute, float> CaptureAttributes(GameplayAttributeComponent source, GameplayAttributeComponent target)
    {
...
public class DamageExecution : GameplayEffectExecutionCalculation
{
    ...
    protected override void CalculateExecution(GameplayEffect effect, GameplayAttributeComponent source, GameplayAttributeComponent target,
        Dictionary<GameplayAttribute, float> capturedAttributes, ref Dictionary<GameplayAttribute, float> outModifications)
    {
        ...
        float critChance = capturedAttributes.TryGetValue(CritChanceAttribute, out float critChanceValue) ? critChanceValue : 0;
        float sourceCritMulti = capturedAttributes.TryGetValue(DodgeChanceAttribute, out float sourceCritMultiValue) ? sourceCritMultiValue : 1.5f;
        float dodgeChance = capturedAttributes.TryGetValue(DodgeChanceAttribute, out float dodgeChanceValue) ? dodgeChanceValue : 0;
