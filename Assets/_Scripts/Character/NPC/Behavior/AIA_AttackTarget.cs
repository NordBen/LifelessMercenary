...
namespace Unity.Behavior
{
    ...
    [NodeDescription(name: "AttackTarget", story: "[Self] Attacks [Target]", category: "Action",
        id: "6bba239928840ea064de36a8765ee3d0")]
    public partial class AIA_AttackTarget : Action
    {
        ...
        protected override Status OnUpdate()
        {
            ...
            bool boolUpdateTargetPosition =
                ...
                || !Mathf.Approximately(m_LastTargetPosition.y,
                    Target.Value.transform.position.y)
                || !Mathf.Approximately(m_LastTargetPosition.z,
        ...
        private Status Initialize()
        {
            ...
            if (m_Animator != null)
            {
                m_Animator.SetFloat(AnimatorSpeedParam, AnimationSpeed);
            }
        ...
        private void RotateToFaceTarget()
        {
            ...
            // Get direction to target (ignore Y axis for flat rotation)
            Vector3 targetPosition = m_ColliderAdjustedTargetPosition;
            Vector3 agentPosition = Agent.Value.transform.position;
