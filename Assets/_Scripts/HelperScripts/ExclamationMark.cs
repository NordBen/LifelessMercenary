...
{
    [SerializeField] private float m_targetScale = 1f;        // The final scale we want to reach
    [SerializeField] private float m_duration = 0.5f;         // How long the animation takes
    [SerializeField] private float m_overshootAmount = 1.2f;  // How much to overshoot (1.2 = 20% over target)
    [SerializeField] private float m_springiness = 6f;        // Controls bounce frequency
