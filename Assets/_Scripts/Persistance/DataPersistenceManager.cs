...
public class DataPersistenceManager : MonoBehaviour
{
    ...
    public void NewGame() 
    {
        this.gameData = new SaveGameData();
    }
    ...
    public void SaveGame()
    {
        ...
        foreach (IDataPersistance dataPersistenceObj in dataPersistenceObjects) 
        {
            Debug.Log($"Saving Game for {dataPersistenceObj}");
        ...
        Debug.Log("called dataHandler.Save(gameData, selectedProfileId);");
    }
    ...
    public Dictionary<string, SaveGameData> GetAllProfilesGameData() 
    {
