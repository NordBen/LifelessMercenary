...
namespace LM.UI
{
    public class ValueProgressBar : UIValueTextElement
    {
        ...
        private BaseCharacterOld owner2;
        ...
        {
            owner2.OnHPChanged += UpdateProgressBar; // subscribes to HPChange event of owner
        }

        private void OnDisable()
        {
            owner2.OnHPChanged -= UpdateProgressBar; // unsubscribes from HPChange event of owner
        }

        private void InitProgressBar()
        {
            UpdateProgressBar(owner2.GetMaxHP());
        }
        ...
        private void UpdateProgressBar(float newValue)
        {
            ...
            if (this._otherValue <= 0)
                this._otherValue = (int)owner2.GetMaxHP();
